...
from db_compat import (
    get_user_by_id, calculate_due_date,
    upsert_calendar_entry, get_holidays_only, create_leave, delete_leave
)
...
class TestCalendarLeaves(unittest.TestCase):
    ...
    def test_prazo_com_feriado_dinamico(self):
        ...
        start_date = date(2024, 2, 5) # Segunda
        feriado_date = date(2024, 2, 7) # Quarta
