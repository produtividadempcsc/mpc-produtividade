...
with k7: st.metric("⏱️ Tempo Médio (Servidores)", f"{tm_serv:.1f} dias", help="Métrica 2 do Relatório Mensal")
with k8: st.metric("⏱️ Tempo Médio de Revisão (Chefes)", f"{tm_chefe:.1f} dias", help="Métrica 6 do Relatório Mensal")
with k9: st.metric("🎯 % Conclusão no Prazo (Serv)", f"{pct_prazo_serv:.1f}%", help="Métrica 3 do Relatório Mensal")

with k10: st.metric("🎯 % Revisão no Prazo (Chefes)", f"{pct_prazo_chefe:.1f}%", help="Métrica 7 do Relatório Mensal")
