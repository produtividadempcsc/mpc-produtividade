...
from db_compat import (
    get_user_leaves, get_all_users, get_user_by_id, 
    get_direct_servants, get_leaves_filtered, get_leaves_count,
    get_active_leaves_count, create_leave, delete_leave
)
...
def render_gerenciar_afastamentos():
    ...
    with st.expander("➕ Registrar Novo Afastamento", expanded=False):
        with st.form("new_leave"):
            ...
            d_ini = c2.date_input("Início", value=date.today())
