...
if not df_produzidos.empty:
    ...
    st.plotly_chart(fig_ind1, width='stretch')
else:
...
if not df_produzidos.empty:
    ...
    st.plotly_chart(fig_ind2, width='stretch')
else:
...
if history_proc:
    ...
    st.plotly_chart(fig_ind3, width='stretch')
else:
...
if not df_produzidos.empty:
    ...
    st.plotly_chart(fig_ind4, width='stretch')
else:
...
if not df_ind5.empty:
    ...
    st.plotly_chart(fig_ind5, width='stretch')
else:
